...
>
	<CalendarPrimitive.MonthSelect bind:ref class="absolute inset-0 cursor-pointer bg-background text-center text-foreground opacity-0" style="color-scheme: dark;" {...restProps}>
